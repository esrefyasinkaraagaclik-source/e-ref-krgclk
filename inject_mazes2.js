...
const qT4_1 = [
  { id: "q1", questionText: "1 mol maddenin içerdiği tanecik sayısına ne ad verilir?", options: [ {id:"1", text:"Avogadro Sayısı", isCorrect:true}, {id:"2", text:"Rutherford Say", isCorrect:false}, {id:"3", text:"Bohr Sayısı", isCorrect:false}, {id:"4", text:"Kütle", isCorrect:false} ]},
...
const qT4_2 = [
  ...
  { id: "q2", questionText: "Bir bileşikteki en sade element oranını gösteren formül?", options: [ {id:"1", text:"Basit Formül", isCorrect:true}, {id:"2", text:"Gerçek Formül", isCorrect:false}, {id:"3", text:"Molekül Formül", isCorrect:false}, {id:"4", text:"Kütle", isCorrect:false} ]},
...
const qT7_1 = [
  ...
  { id: "q3", questionText: "Kum ve suyu birbirinden ayırma yöntemi?", options: [ {id:"1", text:"Süzme", isCorrect:true}, {id:"2", text:"Damıtma", isCorrect:false}, {id:"3", text:"Mıknatıs", isCorrect:false}, {id:"4", text:"AyırmaHunisi", isCorrect:false} ]}
];
...
const qT7_2 = [
  ...
  { id: "q3", questionText: "Demir tozu ve kükürt tozunu en kolay nasıl ayırırız?", options: [ {id:"1", text:"Mıknatısla", isCorrect:true}, {id:"2", text:"Suya atıp", isCorrect:false}, {id:"3", text:"Isıtarak", isCorrect:false}, {id:"4", text:"Damıtarak", isCorrect:false} ]}
];

const inserts = [
  { trigger: /id: "tema2",/, replace: generateMaze("t1_mz", "Labirent 1: Fiziksel Değişimler", qT1_1, "Labirent 2: Kimyasal Değişimler+", qT1_2) + '\n    ]\n  },\n  {\n    id: "tema2",' },
  { trigger: /id: "tema3",/, replace: generateMaze("t2_mz", "Labirent 1: Katılar ve Sıvılar", qT2_1, "Labirent 2: Gazlar ve Plazma+", qT2_2) + '\n    ]\n  },\n  {\n    id: "tema3",' },
  { trigger: /id: "tema4",/, replace: generateMaze("t3_mz", "Labirent 1: Tepkime Türleri", qT3_1, "Labirent 2: Karışık Tepkimeler+", qT3_2) + '\n    ]\n  },\n  {\n    id: "tema4",' },
  { trigger: /id: "tema5",/, replace: generateMaze("t4_mz", "Labirent 1: Mol Hesaplamaları", qT4_1, "Labirent 2: Mol Uzmanı+", qT4_2) + '\n    ]\n  },\n  {\n    id: "tema5",' },
  { trigger: /id: "tema6",/, replace: generateMaze("t5_mz", "Labirent 1: Gaz Yasaları", qT5_1, "Labirent 2: Kinetik Uzmanlık+", qT5_2) + '\n    ]\n  },\n  {\n    id: "tema6",' },
  { trigger: /id: "tema7",/, replace: generateMaze("t6_mz", "Labirent 1: pH Özellikleri", qT6_1, "Labirent 2: Asit Baz Formülleri+", qT6_2) + '\n    ]\n  },\n  {\n    id: "tema7",' },
  { trigger: /];$/, replace: generateMaze("t7_mz", "Labirent 1: Karışımlar", qT7_1, "Labirent 2: Alaşımlar ve Ayırma+", qT7_2) + '\n    ]\n  }\n];' },
];

for (const block of inserts) {
  content = content.replace(
      new RegExp("\\n\\s*\\]\\n\\s*\\},\\n\\s*\\{\\n\\s*" + block.trigger.source), 
      block.replace
  );
  if (block.trigger.source === '\\];$') {
      content = content.replace(/\n\s*\]\n\s*\}\n\];$/, block.replace);
  }
}
