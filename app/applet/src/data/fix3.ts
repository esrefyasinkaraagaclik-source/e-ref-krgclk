...
function generateQuestionsForTopic(topic: string, count: number) {
  ...
  pools['t5'] = [
    ...
    { q: "P.V = n.R.T denklemine ne ad verilir?", a: "İdeal Gaz Denk.", w: ["Kısmi Basınç", "Graham Difüzyon", "Van der Waals"] },
    ...
    { q: "Hafif gaz molekülleri ağır gaz moleküllerine göre nasıl hareket eder?", a: "Hızlı", w: ["Yavaş", "Aynı", "Fark yok"] },
    { q: "Gaz moleküllerinin hızları mutlak sıcaklığın (Kelvin) nesiyle orantılıdır?", a: "Kareköküyle", w: ["Karesiyle", "Kendisiyle", "Küpüyle"] },
    { q: "Dalton'un Kısmi Basınçlar Yasasına göre toplam basınç neye eşittir?", a: "Kısmi P toplamına", w: ["Hacim toplamına", "Sıcaklığa", "Mol çarpımına"] },
    ...
    { q: "Bütün molekül hareketlerinin durduğu varsayılan 0 K sıcaklığa ne denir?", a: "Mutlak Sıfır", w: ["Donma Noktası", "Kritik", "Eksi Bir"] },
    { q: "İdeal olmayan ve doğada bulunan gazlara ne denir?", a: "Gerçek Gaz", w: ["Asal Gaz", "Süper Gaz", "Plazma"] },
    { q: "Gerçek bir gazı ideal gaza yaklaştırmak için sıcaklık ve basınç nasıl olmalı?", a: "Yüksek T - Düşük P", w: ["Düşük T - Düşük P", "Yüksek P - Düşük T", "Yüksek P - Yüksek T"] },
    { q: "Gaz tanecikleri arasındaki esnek çarpışmalarda ne korunur?", a: "Kinetik Enerji", w: ["Yarıçap", "Bağ Enerjisi", "Sıcaklık"] },
    { q: "Bir gazın sıvılaştırılamadığı sınırı belirleyen en yüksek sıcaklık nedir?", a: "Kritik Sıcaklık", w: ["Kaynama Noktası", "Kırağı Noktası", "Süblimleşme"] },
    ...
    { q: "Gaz basıncı, taneciklerin kap içerisindeki birim alana yaptığı ne ile açıklanır?", a: "Çarpma Kuv.", w: ["Ağırlık", "Ses dalgaları", "Atom yarıçapı"] }
  ];
  ...
  pools['t6'] = [
    ...
    { q: "Çamaşır suyu içeren çözeltinin özelliği?", a: "Bazik", w: ["Asidik", "Nötr", "Zayıf Asit"] },
    ...
    { q: "Tuz ruhunun kimyasal adı/formülü nedir?", a: "HCl", w: ["Sülfürik Asit", "Nitrik Asit", "Asetik Asit"] }
  ];

  pools['t7'] = [
    { q: "Kimyasal özellikleri değişmeden fiziksel olarak birleşmesi?", a: "Karışım", w: ["Bileşik", "Element", "Molekül"] },
    { q: "Her yerinde aynı özelliği gösteren, tek görünüm fazlı karışımlara ne denir?", a: "Homojen Krş.", w: ["Heterojen Krş.", "Süspansiyon", "Emülsiyon"] },
    { q: "Madde dağılımı her yerde aynı olmayan karışımlara ne denir?", a: "Heterojen Krş.", w: ["Çözelti", "Alaşım", "Kolloid"] },
    { q: "Tuzlu su ne tür bir karışımdır?", a: "Homojen", w: ["Heterojen", "Emülsiyon", "Süspansiyon"] },
    { q: "Zeytinyağı-Su ne tür bir karışımdır?", a: "Emülsiyon", w: ["Homojen", "Alaşım", "Gaz çözeltisi"] },
    ...
    { q: "İki birbiri içinde çözünmeyen sıvının dağılması? (Sıvı-Sıvı heterojen)", a: "Emülsiyon", w: ["Süspansiyon", "Aerosol", "Alaşım"] },
    { q: "Sis, duman ve spreyler hangi karışıma örnektir?", a: "Aerosol", w: ["Kolloid", "Süspansiyon", "Çözelti"] },
    { q: "Gözle homojen görünen ancak mikroskopla fazları ayrılabilen karışım?", a: "Kolloid", w: ["Basit Karışım", "Çözelti", "Süspansiyon"] },
    { q: "Metallerin eritilip karıştırılmasıyla oluşan katı-katı çözeltileri?", a: "Alaşım", w: ["Kompozit", "Emülsiyon", "Polimer"] },
    ...
    { q: "Kan hangi karışım türüne örnektir?", a: "Kolloid", w: ["Homojen", "Emülsiyon", "Gaz Çözeltisi"] },
    { q: "Ayırma hunisi hangi tür karışımları ayırmak için kullanılır?", a: "Sıvı-Sıvı Heterojen", w: ["Katı-Katı hm.", "Sıvı-Gaz hm.", "Aerosol"] },
    { q: "Ayrımsal damıtma, karışımları ayırırken hangi farktan yararlanır?", a: "Kaynama Nok.", w: ["Erime Nok.", "Boyut", "Özkütle"] },
    ...
    { q: "Makarna suyu süzülürken hangi özellik farkından yararlanılır?", a: "Boyut", w: ["Kaynama", "Mıknatıs", "Özkütle"] }
  ];
